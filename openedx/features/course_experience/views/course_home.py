...
from openedx.features.course_experience.utils import get_first_purchase_discount_banner_fragment
...
class CourseHomeFragmentView(EdxFragmentView):
    ...
    def render_to_fragment(self, request, course_id=None, **kwargs):
        ...
        if user_access['is_enrolled'] or user_access['is_staff']:
            ...
            discount_banner_fragment = get_first_purchase_discount_banner_fragment(
                request.user,
                course_overview
            )
        ...
        context = {
            ...
            'discount_banner_fragment': discount_banner_fragment,
